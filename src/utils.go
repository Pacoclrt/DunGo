...
var (
	campColors  = []string{White, Yellow, Gold, Gold, Orange, Brown}
	stoneColors = []string{White, Silver, Silver, Gray}
	mossColors  = []string{Lime, Lime, Green, Green, Green, Gray}
	iceColors   = []string{White, Sky, Sky, Blue, Blue, Gray}
