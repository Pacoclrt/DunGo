...
| Changement | Détail |
|---|---|
| **Taverne supprimée** | Brom, la bière et les rumeurs disparaissent. Les quêtes deviennent des **missions**, accessibles depuis le menu **Missions** du camp. |
| **Succès supprimés** | Plus de menu Succès ni de succès à débloquer. |
| **Mode Hardcore supprimé** | Il reste trois difficultés : Facile, Normal et Difficile. À la mort, on ressuscite toujours au camp. |
| **Bips supprimés** | Le terminal ne sonne plus pendant la partie. |
| **Sphinx plus simple** | Les énigmes sont des questions faciles, sans piège. |
| **Krokmou** | Le bébé dragon de l'étage 3 (l'ancien « Drakonide ») s'appelle désormais **Krokmou**. |
| **Arène sans butin** | L'entraînement ne rapporte plus ni Y-Coins ni XP, et on n'y meurt plus pour de vrai : il servait à monter de niveau sans aucun risque. |
| **Textes repliés** | Les longs textes (prologue, ambiances, répliques) tiennent maintenant dans 80 colonnes. |
| **Code simplifié** | Menus, sorts, difficultés, objets et schémas d'attaque des boss sont décrits dans des **tables** : ajouter du contenu ne demande presque plus de code. Voir [docs/comment-ca-marche.md](docs/comment-ca-marche.md). |
| **ASCII art en braille** | Tous les dessins sont redessinés en braille Unicode (U+2800) : uniquement des points, plus aucun caractère spécial. Le sac à dos, Mordecai, Borin et le Sergent Grol ont été retravaillés. |
| **Feu de camp supprimé** | Plus de repos gratuit au camp : on se soigne avec les potions et les fontaines du donjon. |
| **Journal de chasse supprimé** | Le récapitulatif des monstres vaincus disparaît du menu du camp. |
| **Décors allégés** | Les dessins du camp de la Dernière Lueur et de la montagne de l'Antre d'Ignarok ne sont plus affichés. |
| **Code simplifié** | Données regroupées en tableaux, boucle de combat unique, commentaires inutiles retirés. |
